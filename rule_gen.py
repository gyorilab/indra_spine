...
def create_br_ph_rules(br_rule, ph_rule):
    if br_rule != "{}* (?<region> [chunk=B-NP]|[chunk=I-NP]|[chunk=B-NP][chunk=I-NP]|[chunk=B-Organ]|[chunk=I-Organ]|[chunk=B-Organ][chunk=I-Organ]|[chunk=B-TissueType]|[chunk=I-TissueType]|[chunk=B-TissueType][chunk=I-TissueType])" and br_rule != "(?<region> {}* [])" and br_rule != "(?<region> {}* [] [])" and br_rule != "(?<region> {}* [chunk=B-NP]|[chunk=I-NP]|[chunk=B-NP][chunk=I-NP])":
